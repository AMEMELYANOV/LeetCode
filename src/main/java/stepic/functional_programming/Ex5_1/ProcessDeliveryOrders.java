package stepic.functional_programming.Ex5_1;
...
//                .collect(Collectors.toList());
        ...
        List<DeliveryOrder> emptyOrders = List.of();

        System.out.println(findFirstOrder(emptyOrders));

        printAddressesToDeliver(emptyOrders);
    }
}
